...
namespace SEWorkshop.ServiceLayer
{
    public interface IUserManager
    {
        ...
        public void AddProductCategoryDiscount(string sessionId, string storeName, string categoryName, string deadline, double percentage, Operator op, int indexInChain);
        public void AddSpecificProductDiscount(string sessionId, string storeName, string productName, string deadline, double percentage, Operator op, int IndexInChain);
