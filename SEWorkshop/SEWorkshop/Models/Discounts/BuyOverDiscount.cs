...
namespace SEWorkshop.Models.Discounts
{
    public abstract class BuyOverDiscount : ConditionalDiscount
    {
        ...
        public BuyOverDiscount(Store store, int minSum, int offSum, double percentage, DateTime deadline, Product product, User user) : base(percentage, deadline, product, store, user)
        {
            Store = store;
            MinSum = minSum;
            OffSum = offSum;
