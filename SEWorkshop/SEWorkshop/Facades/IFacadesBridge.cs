...
namespace SEWorkshop.Facades
{
    public interface IFacadesBridge
    {
        ...
        public DataPurchase Purchase(DataUser user, DataBasket basket, string creditCardNumber, DateTime expirationDate, string cvv, Address address, string username, string id);
