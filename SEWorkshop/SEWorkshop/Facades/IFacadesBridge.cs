...
namespace SEWorkshop.Facades
{
    public interface IFacadesBridge
    {
        ...
        public void AddProductCategoryDiscount(DataLoggedInUser user, string storeName, string categoryName, string deadline, double percentage, Operator op, int indexInChain);
        public void AddSpecificProductDiscount(DataLoggedInUser user, string storeName, string productName, string deadline, double percentage, Operator op, int indexInChain);
